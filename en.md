## Included Audio Files in Examples
I am not satisfied with the .csv that FrSky uses as I feel it is missing some sounds, especially for helicopters.  As such I use my own list.<br>

If you are just here to download my sample audiopacks, you can find a list below of all tracks included.  If you want to request a new text-to-play to be added, you can create a GitHub issue and I will generate it and update the samples and this list.
...
| battery.wav                              | battery                                        |
| bec-volt.wav                             | B E C voltage                                  |
| bec-volt-warn.wav                        | B E C voltage warning                          |
| bec-volt-crit.wav                        | B E C voltage critical                         |
| brakes-off.wav                           | brakes off                                     |
| brakes-on.wav                            | brakes on                                      |
| butterfly-off.wav                        | butterfly off                                  |
| butterfly-on.wav                         | butterfly on                                   |
| cell-avg.wav                             | battery average cell                           |
| cell-avg-volt-low.wav                    | average cell voltage low                       |
| cell-avg-volt-crit.wav                   | average cell voltage critical                  |
...
| gear-up.wav                              | gear up                                        |
| gyro-off.wav                             | gyro off                                       |
| gyro-on.wav                              | gyro on                                        |
| gyro-self-level.wav                      | gyro self leveling                             |
| horizon.wav                              | horizon                                        |
...
| temp.wav                                 | temperature                                    |
| temp-warn.wav                            | temperature warning                            |
| temp-crit.wav                            | temperature critical                           |
| temp-esc.wav                             | E S C temperature                              |
| temp-esc-warn.wav                        | E S C temperature warning                      |
| temp-esc-crit.wav                        | E S C temperature critical                     |
| temp-mcu.wav                             | M C U temperature                              |
| temp-mcu-warn.wav                        | M C U, temperature warning                     |
| temp-mcu-crit.wav                        | M C U, temperature critical                    |
| temp-motor.wav                           | motor temperature                              |
| temp-motor-warn.wav                      | motor temperature warning                      |
| temp-motor-crit.wav                      | motor temperature critical                     |
| temp-servo.wav                           | servo temperature                              |
| temp-servo-warn.wav                      | servo temperature warning                      |
| temp-servo-crit.wav                      | servo temperature critical                     |
| temp-egt.wav                             | EGT                                            |
| temp-egt-warn.wav                        | EGT warning                                    |
| temp-egt-crit.wav                        | EGT critical                                   |
...
| vector-off.wav                           | vectoring off                                  |
| vector-on.wav                            | vectoring on                                   |
| vector-normal.wav                        | vectoring normal                               |
| vector-hover.wav                         | vectoring hover                                |
| vtx-off.wav                              | VTX off                                        |
